...
label_data_name = "loss_batch_no_over_data_mile_15_28.5_total_60_predict_1_5.npy"
...
def main(_):
    with tf.get_default_graph().as_default() as graph:
        ...
        raw_data_t = raw_data_t[:233472, :, :, :5]
        ...
        with tf.Session() as sess:
            ...
            for epoch_steps in range(FLAGS.total_epoches):
                ...
                for i in range(train_batches_amount):
                    temp_idx = i*FLAGS.batch_size
                    current_X_batch = train_raw_data[temp_idx:temp_idx + FLAGS.batch_size]
                    current_Y_batch = train_label_data[temp_idx:temp_idx + FLAGS.batch_size]
                ...
                for i in range(test_batches_amount):
                    temp_idx = i*FLAGS.batch_size
                    current_X_batch = test_raw_data[temp_idx:temp_idx + FLAGS.batch_size]
                    current_Y_batch = test_label_data[temp_idx:temp_idx + FLAGS.batch_size]
