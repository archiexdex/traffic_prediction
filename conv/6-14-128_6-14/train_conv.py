...
raw_data_name = "cnn_batch_no_over_data_mile_15_28.5_total_60_predict_1_5.npy"
label_data_name = "cnn_label_no_over_data_mile_15_28.5_total_60_predict_1_5.npy"
...
def main(_):
    with tf.get_default_graph().as_default() as graph:
        ...
        # [density, flow, speed, weekday, time]
        raw_data_t = raw_data_t[:, :, :, :5]
        label_data_t = label_data_t[:, :, :14, 1]
        ...
        Y_ph = tf.placeholder(dtype=tf.float32, shape=[
                              FLAGS.batch_size, 6, 14], name='label_data')
