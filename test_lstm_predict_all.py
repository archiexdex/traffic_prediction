...
tf.app.flags.DEFINE_string('log_dir', 'backlog/' + raw_data_name[11:-4] + '/test_predict_log/',
                           "summary directory")
        ...
        with tf.Session() as sess:
            ...
            for i in range(len(test_label_data) - 1):
                ...
                if flg and temp[i][0][3] == 2:
                    ...
                    if result is None:
                        result = test_raw_data[i:i + 1]
                    print(result)
                    current_X_batch = result
                    ...
                    result = np.concatenate(
                        [result[:, :-1, :], predicted_value_np], axis=1)
